...
template <class Impl, std::size_t N_INSTANCES>
alignas(std::alignment_of_v<Impl>) inline std::array<typename HardwarePeripheralWrapper<Impl, N_INSTANCES>::weak_handle_t, N_INSTANCES> HardwarePeripheralWrapper<Impl, N_INSTANCES>::instance_handles{};